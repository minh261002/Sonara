            ...
            <div className='max-w-6xl mx-auto px-4'>
                ...
                >
                    {integrations.map((integration, index) => (
                        ...
                        >
                            <motion.div
                                className='w-16 h-16 mx-auto mb-4 bg-card/5 backdrop-blur-sm rounded-xl p-3 border border-border/50 transition-all duration-300 group-hover:bg-card/10 group-hover:border-border/70'
                                whileHover={{
                                    rotate: [0, -5, 5, 0],
